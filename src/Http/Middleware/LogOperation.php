...
namespace Dcat\Admin\XqwLog\Http\Middleware;

use Dcat\Admin\Admin;
use Dcat\Admin\XqwLog\Models\XqwLog as XqwLogModel;
...
class LogOperation
{
    ...
    {
        return XqwLogServiceProvider::setting($key, $default);
    }
